...
public class AdapterContacto extends RecyclerView.Adapter<AdapterContacto.ViewHolder> {
  ...
  public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View v = inflador.inflate(R.layout.layout_item_contacto, parent, false);return new ViewHolder(v);
  }
  @Override
  public void onBindViewHolder(ViewHolder holder, final int i) {
    ...
    //Sirve para recorrer el recycler
    holder.mInitialsBackground.setColor(colors[i % colors.length]);
    holder.itemView.setOnClickListener(new View.OnClickListener(){
      @Override
      public void onClick(View v) {
        Intent intent = new Intent(micontext, UpdateContacto.class);
        intent.putExtra(UpdateContacto.EXTRA_CONTACT_ID, contact.getPhoneNumber());
  ...
  //Notifica que se cambia los datos
